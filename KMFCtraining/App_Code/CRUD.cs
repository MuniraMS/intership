...
/// </summary>
/// 
namespace KMFCtraining.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["KfmcTrainingConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["KfmcTrainingConStr"].ConnectionString);
        public CRUD()
        {
            //
